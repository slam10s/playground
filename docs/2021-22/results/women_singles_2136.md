...
══════════════════════════════════════════════════════════════════════════
 ...
 > Flight C Backdraw
  ...
  > Main
     ...
     SF  Whitney King           def.  Aleksandra Vorozheiki… 64 26 [8]
     SF  Samantha Johns         def.  Meghana Komarraju      61 67(3) [5]
     QF  Whitney King           def.  Katreina Corpuz        62 62
     QF  Aleksandra Vorozheiki… def.  Junmoke James          61 61
     ...
     16  Aleksandra Vorozheiki… def.  Lauren Quinn           63 60
...
══════════════════════════════════════════════════════════════════════════
 ...
 > LU vs ECU, WM vs MU
  > Main
     ...
     64  Maria Juliana Parra R… def.  Ines Bachir el Bouhali 61 63
  ...
  > Main
     ...
     64  Maria Juliana Parra R… def.  Jutte Van Hansewyck    61 62
  ...
  > Main
     ...
     64  Maria Juliana Parra R… def.  Emma Fernald           Walkover
...
══════════════════════════════════════════════════════════════════════════
 ...
 > SIUE vs WIU, Bradley vs EIU
  > Main
     ...
     32  Rachel Papavasilopoul… def.  Sandra Maletin         36 64 [3]
     32  Bozana Lojpur          def.  Elizaveta Bukraba-Ula… 60 63
  ...
  > Main
     ...
     32  Elizaveta Bukraba-Ula… def.  Lorena Castellanos     60 61
  ...
  > Main
     32  Jordan Schifano        def.  Elizaveta Bukraba-Ula… 62 61
...
══════════════════════════════════════════════════════════════════════════
 ...
 > Flight 1
  > East
     ...
     QF  Rishona Israel-Lewis   def.  Valentina Gonzalez Ra… 63 64
  ...
  > West
     ...
     SF  Deniza Marcinkevica    def.  Valentina Gonzalez Ra… 67(4) 64 [8]
  > 3-4 Playoff
      F  Allison Stewart        def.  Rishona Israel-Lewis   61 60
  > South
      F  Nina Mitrofanova       def.  Valentina Gonzalez Ra… 46 Ret.
  > Flight 2
  > East
...
══════════════════════════════════════════════════════════════════════════
 ...
 > Flight A
  ...
  > Flight F
  > East
      F  Ira Vogelmann          def.  Valerie Idalia Navarr… 64 57 [9]
     SF  Valerie Idalia Navarr… def.  Taylor Parkinson       62 63
     SF  Ira Vogelmann          def.  Ella Cummings          61 63
     QF  Valerie Idalia Navarr… def.  Kayleigh Gardner       60 60
  ...
  > Main
     ...
     SF  Constanza Gomez        def.  Ashleigh Cooper Linds… 60 60
     SF  Sarah Castleberry      def.  Barbara Cano           62 60
  > Consolation
      F  Barbara Cano           def.  Ashleigh Cooper Linds… 61 64
  > Flight X
  > Main
...
════════════════════════════════════════════════════════════════════════
 ...
 > Blue
  ...
  > East
     ...
     QF  Lily Aranyos         def.  Marie Bertran De Bala… 64 63
  > West
      F  Summer Reeves        def.  Natasha Forrest        46 62 [7]
     SF  Summer Reeves        def.  TAMARA MACIAS          60 36 [7]
     SF  Natasha Forrest      def.  Marie Bertran De Bala… Walkover
  > 3-4 Playoff
      F  Veronika Poliakova   def.  Lily Aranyos           62 63
  > South
      F  TAMARA MACIAS        def.  Marie Bertran De Bala… Walkover
  > Green
  > East
