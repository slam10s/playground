...
═════════════════════════════════════════════════════════════════════════════════
 ...
 > Crimson Flight 1
  > East
      F     Rastrojo/Deli              def.     Rodriguez Garceran/Sancho… 85
     SF (1) Rastrojo/Deli              def.     Menard/Simecek             86
     SF     Rodriguez Garceran/Sancho… def.     Dillon/Ziomber             85
     ...
     QF     Rodriguez Garceran/Sancho… def. (2) Tumosa/Straker-Meads       82
     ...
     16     Rodriguez Garceran/Sancho… def.     Lock/Vega                  82
  > West
