...
═════════════════════════════════════════════════════════════════
 ...
 > Flight A
  > Main
     ...
     QF  Tannenbaum/Taggart   def.  Vorozheikina/Kubanov 83
  ...
  > Flight A Backdraw
  > Main
      F  James/Imhof          def.  Vorozheikina/Kubanov 87(6)
     SF  Vorozheikina/Kubanov def.  Gasser/Spurka        85
  ...
  > Main
     ...
     16  Moore/Johns          def.  Araceli Velilla/Jans 83
  ...
  > Main
     ...
     QF  Dania/Dania          def.  Araceli Velilla/Jans 85
...
═════════════════════════════════════════════════════════════════
 ...
 > Doubles Rd. 1
  > Main
     16  Nguyen/Parra Romero  def.  Bachir el Bouhali/Ch 63
     16  Burger/Almborg       def.  Diercksen/Muzzolon   63
     16  Saraty/Lovato        def.  Hussain/Joseph       64
     16  Saric/Alhach         def.  Stefancic/Van Hansew 62
     16  Clairotte/Vanderheyd def.  Gurholt/Fernald      64
     16  Ballow/Gillar        def.  van Meeteren/Cricchi 63
...
═════════════════════════════════════════════════════════════════
 ...
 > SIUE vs. WIU, Bradley vs. EIU
  > Main
     ...
     16  Perlwitz/Lojpur      def.  Ellis/Bukraba-Ulanov 63
     16  Martinez/Marjanovic  def.  Shinabery/Perez-Kori 61
~~~
...
═════════════════════════════════════════════════════════════════
 ...
 > Flight 1
  > East
     ...
     SF  Crisologo/Stewart    def.  Ovcina/Gonzalez Rami 86
     SF  Komar/Marcinkevica   def.  Arranz/Mocciola      85
     QF  Crisologo/Stewart    def.  Mitrofanova/Lee      83
     QF  Ovcina/Gonzalez Rami def.  McCutcheon/Kvapilova 83
  ...
  > 3-4 Playoff
      F  Arranz/Mocciola      def.  Ovcina/Gonzalez Rami Walkover
  > Flight 2
  > Main
  ...
  > Flight 3
  > Main
     R3  Rodriguez/Vishnevska def.  Shethia/Le           83
     R3  Wahl/Chisholm        def.  Hosking/Vaudiau      85
     R2  Gonzalez/Israel-Lewi def.  Shethia/Le           84
     R2  Guler/Irrinki        def.  Hosking/Vaudiau      83
     R1  Rodriguez/Vishnevska def.  Gonzalez/Israel-Lewi 87(1)
     R1  Guler/Irrinki        def.  Wahl/Chisholm        83
  > Playoff 1
      F  Guler/Irrinki        def.  Rodriguez/Vishnevska 83
  > Playoff 2
      F  Gonzalez/Israel-Lewi def.  Wahl/Chisholm        81
  > Playoff 3
...
═════════════════════════════════════════════════════════════════
 ...
 > Flight A
  ...
  > East
     ...
     SF  Carpenter/Teran      def.  Franco Salcedo/Parki 62
     SF  Vargas/Garcia        def.  Hughes/Miller        61
     QF  Franco Salcedo/Parki def.  Parrott/Denton       60
  ...
  > 3-4 Playoff
      F  Hughes/Miller        def.  Franco Salcedo/Parki 64
  > South
  ...
  > Flight D
  > Main
      F  Munoz/Navarro-Cavazo def.  Castleberry/Omeire   62
     SF  Castleberry/Omeire   def.  Gardner/Hoffman      60
     SF  Munoz/Navarro-Cavazo def.  Nutt/Garcia          60
~~~
...
═════════════════════════════════════════════════════════════════
 ...
 > Women's Doubles
  > Main
     ...
     QF  Cabrera/Cincunegui   def.  Calvo Larraz/Komisza 61
     QF  Limauge/Lentisco     def.  Wijesooryia/Meyer    62
     QF  Lindeboom/Zavala     def.  Ballesteros/Dirninge 63
     QF  Cremer/Kowalke       def.  Isgett/Vukcevic      63
     16  Calvo Larraz/Komisza def.  Trimpe/Marshall      75
     16  Ballesteros/Dirninge def.  Dabbah/Dudic         62
~~~
