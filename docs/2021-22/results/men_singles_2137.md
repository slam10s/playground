...
════════════════════════════════════════════════════════════════════════
 ...
 > Blue
  > Main
     R3  Brooke Covington    def.  Harriet Hamilton     61 57 [8]
     R3  Odin Fouchier       def.  Sofia Guaglianone    75 75
     R3  Emily Hibbs         def.  Anders Gibbons       64 61
     R3  Velizara Fileva     def.  Ian Chen             61 46 [4]
     R2  Harriet Hamilton    def.  Odin Fouchier        61 57 [7]
     R2  Brooke Covington    def.  Sofia Guaglianone    64 63
     R2  Emily Hibbs         def.  Ian Chen             61 62
     R2  Velizara Fileva     def.  Anders Gibbons       60 64
     R1  Brooke Covington    def.  Odin Fouchier        62 26 [6]
     R1  Harriet Hamilton    def.  Sofia Guaglianone    26 61 [2]
     R1  Ian Chen            def.  Anders Gibbons       62 60
     R1  Velizara Fileva     def.  Emily Hibbs          76(3) 62
  > Playoff 1
      F  Velizara Fileva     def.  Brooke Covington     Walkover
  > Playoff 2
      F  Emily Hibbs         def.  Harriet Hamilton     75 63
  > Playoff 3
      F  Ian Chen            def.  Odin Fouchier        60 63
 > Purple
  > Main
     R3  Peter Conklin       def.  Hiroki Fujita        64 61
     R3  Adeline Flach       def.  Florencia Fuentes    63 62
     R3  Margot Fontaine     def.  Alyssa Davila        60 64
     R3  Adrien Burdet       def.  Ana Alvarez          61 61
     R2  Hiroki Fujita       def.  Adeline Flach        76(3) 62
     R2  Peter Conklin       def.  Florencia Fuentes    63 62
     R2  Margot Fontaine     def.  Ana Alvarez          60 62
     R2  Adrien Burdet       def.  Alyssa Davila        61 62
     R1  Adeline Flach       def.  Peter Conklin        46 64 [5]
     R1  Florencia Fuentes   def.  Hiroki Fujita        61 63
     R1  Alyssa Davila       def.  Ana Alvarez          64 61
     R1  Adrien Burdet       def.  Margot Fontaine      75 61
 > Red
  > Main
     R3  Chase Henry         def.  Jessica Fatemi       57 62 [4]
     R3  Scott Bickel        def.  Lucy Bruns           63 63
     R3  Nicole Coopersmith  def.  Andres Golindano     64 63
     R3  John Hejl           def.  Sima Heren           63 46 62
     R2  Jessica Fatemi      def.  Lucy Bruns           64 76(7)
     R2  Chase Henry         def.  Scott Bickel         62 76(5)
     R2  John Hejl           def.  Nicole Coopersmith   76(4) 63
     R1  Chase Henry         def.  Lucy Bruns           62 63
     R1  Jessica Fatemi      def.  Scott Bickel         63 76(2)
     R1  Nicole Coopersmith  def.  Sima Heren           61 30 Ret.
     R1  John Hejl           def.  Andres Golindano     63 Ret.
  > Playoff 1
      F  Chase Henry         def.  John Hejl            60 76(2)
  > Playoff 2
      F  Jessica Fatemi      def.  Nicole Coopersmith   Walkover
 > White
  > Main
     R3  Randi Hendricks     def.  Chris Fok Kow        60 63
     R3  Dannie Evans        def.  Calista Fuller       60 62
     R3  Tizia Brocks        def.  Alejandro Barrero    63 76(4)
     R3  Maxi Duncan         def.  Tomas Barrera        75 64
     R2  Randi Hendricks     def.  Dannie Evans         46 63 [5]
     R2  Chris Fok Kow       def.  Calista Fuller       75 64
     R2  Tomas Barrera       def.  Tizia Brocks         76(2) 26 [7]
     R2  Maxi Duncan         def.  Alejandro Barrero    46 75 [8]
     R1  Dannie Evans        def.  Chris Fok Kow        63 64
     R1  Randi Hendricks     def.  Calista Fuller       62 64
     R1  Tomas Barrera       def.  Alejandro Barrero    62 62
     R1  Maxi Duncan         def.  Tizia Brocks         75 76(4)
  > Playoff 1
      F  Maxi Duncan         def.  Randi Hendricks      64 75
 > Green
  > Main
     R3  Daniel Fouchier     def.  Mathilde Depery      26 75 [3]
     R3  Sabrina Dickerson   def.  jil Engelmann        64 60
     R3  Joe Harris          def.  Austreberto Carlon   60 60
     R3  Spencer Bourn       def.  Kenden Aguilera      76(5) 57 [5]
     R2  jil Engelmann       def.  Mathilde Depery      63 46 [5]
     R2  Daniel Fouchier     def.  Sabrina Dickerson    63 63
     R2  Austreberto Carlon  def.  Kenden Aguilera      36 62 [8]
     R2  Joe Harris          def.  Spencer Bourn        63 63
     R1  Daniel Fouchier     def.  jil Engelmann        16 60 [5]
     R1  Sabrina Dickerson   def.  Mathilde Depery      Walkover
     R1  Joe Harris          def.  Kenden Aguilera      61 63
     R1  Spencer Bourn       def.  Austreberto Carlon   64 60
  > Playoff 1
      F  Daniel Fouchier     def.  Joe Harris           60 62
  > Playoff 4
      F  Kenden Aguilera     def.  Mathilde Depery      Walkover
 > Yellow
  > Main
     R3  Victor De Oliveira  def.  JJ Chen              64 61
     R3  Melissa Gish        def.  Frank Borden         16 62 [6]
     R3  Michael Bukhalo     def.  Lucas Guy            75 62
     R3  Alberto Colas       def.  Alisha Chulani       75 76(2)
     R2  Frank Borden        def.  JJ Chen              62 62
     R2  Victor De Oliveira  def.  Melissa Gish         63 63
     R2  Michael Bukhalo     def.  Alberto Colas        60 64
     R2  Alisha Chulani      def.  Lucas Guy            06 63 [6]
     R1  Frank Borden        def.  Victor De Oliveira   26 62 [8]
     R1  Melissa Gish        def.  JJ Chen              06 61 [6]
     R1  Lucas Guy           def.  Alberto Colas        62 64
     R1  Michael Bukhalo     def.  Alisha Chulani       63 46 [9]
  > Playoff 1
      F  Michael Bukhalo     def.  Victor De Oliveira   64 63
 > Orange
  > Main
     R3  Oliver Andersson    def.  Luis Felipe Azurduy  64 46 [7]
     R3  Jackson Feather     def.  Karel Blom           67(3) 61 [3]
     R3  Jay Carrillo        def.  Cassidy Greenman     76(4) 62
     R3  Robin Eldin         def.  Catherine Denysiewi… 63 60
     R2  Luis Felipe Azurduy def.  Jackson Feather      61 61
     R2  Oliver Andersson    def.  Karel Blom           62 61
     R2  Jay Carrillo        def.  Robin Eldin          64 64
     R2  Cassidy Greenman    def.  Catherine Denysiewi… 61 60
     R1  Oliver Andersson    def.  Jackson Feather      63 57 [4]
     R1  Luis Felipe Azurduy def.  Karel Blom           62 62
     R1  Cassidy Greenman    def.  Robin Eldin          61 46 [5]
     R1  Jay Carrillo        def.  Catherine Denysiewi… 61 61
  > Playoff 1
      F  Oliver Andersson    def.  Jay Carrillo         36 63 [4]
  > Playoff 2
      F  Luis Felipe Azurduy def.  Cassidy Greenman     76(4) Ret.
 > Maroon
  > Main
     R3  Austin Cramer       def.  Alara Hollyfield     16 64 [8]
     R3  Stefan Dostanic     def.  Brent Fallon         64 60
     R2  Stefan Dostanic     def.  Austin Cramer        63 60
     R2  Brent Fallon        def.  Alara Hollyfield     76(3) 62
     R1  Alara Hollyfield    def.  Stefan Dostanic      62 62
     R1  Brent Fallon        def.  Austin Cramer        64 61
 > Brown
  > Main
     R3  Ben Cronau          def.  Anique Engelbrecht   62 60
     R3  Kendall Couch       def.  Michael Blando       60 61
     R2  Michael Blando      def.  Ben Cronau           46 75 [3]
     R1  Michael Blando      def.  Anique Engelbrecht   61 63
     R1  Kendall Couch       def.  Ben Cronau           61 63
 > Gold
  > Main
     R3  Amira Badawi        def.  Benjamin George      60 64
     R3  Esteban Gutierrez   def.  Jason Harris         64 16 [8]
     R3  Sebastian Buxman    def.  Evan Dean            63 61
     R3  Benjamin Campi      def.  Julianna Begley      61 61
     R2  Benjamin George     def.  Jason Harris         64 36 [7]
     R2  Amira Badawi        def.  Esteban Gutierrez    75 63
     R2  Julianna Begley     def.  Evan Dean            75 61
     R2  Sebastian Buxman    def.  Benjamin Campi       63 63
     R1  Jason Harris        def.  Amira Badawi         63 61
     R1  Benjamin George     def.  Esteban Gutierrez    76(4) 64
     R1  Sebastian Buxman    def.  Julianna Begley      63 62
     R1  Benjamin Campi      def.  Evan Dean            63 63
  > Playoff 1
      F  Amira Badawi        def.  Sebastian Buxman     46 75 [4]
 > Additional Matches
  > Main
     64  Sofia Guaglianone   def.  Alberto Colas        62 64
     64  Stefan Dostanic     def.  Karel Blom           36 63 [5]
     64  Esteban Gutierrez   def.  Michael Blando       46 62 [1]
     64  Ben Cronau          def.  Evan Dean            64 63
     64  Chris Fok Kow       def.  Lucy Bruns           26 76(4) [10]
     64  Anders Gibbons      def.  Austin Cramer        60 60
     64  Kenden Aguilera     def.  jil Engelmann        46 61 [1]
     64  Begona Benjumeda    def.  Sabrina Dickerson    62 60
     64  Jessica Fatemi      def.  Alyssa Davila        64 60
     64  Margot Fontaine     def.  Florencia Fuentes    62 62
     64  Lucas Guy           def.  Melissa Gish         76(2) 36 [11]
     64  Peter Conklin       def.  Adrien Burdet        63 62
     64  Frank Borden        def.  Sima Heren           63 76(5)
     64  Alara Hollyfield    def.  Catherine Denysiewi… 63 60
     64  Julianna Begley     def.  Robin Eldin          63 46 [3]
     64  Jackson Feather     def.  Tomas Barrera        75 75
     64  Benjamin George     def.  Malik Bhatnagar      61 60
     64  Benjamin Campi      def.  Hiroki Fujita        26 62 [1]
     64  Austreberto Carlon  def.  Ana Alvarez          76(4) 60
 > Extra Singles
  > Main
     R2  Begona Benjumeda    def.  Malik Bhatnagar      76(3) 61
     R1  Begona Benjumeda    def.  Sabrina Dickerson    62 60
     R1  Malik Bhatnagar     def.  Kendall Couch        62 62
~~~
...
════════════════════════════════════════════════════════════════════════
 ...
 > Flight A
  > East
      F  Albert Sprlak-Puk    def.  Oliver Johansson    64 64
     SF  Oliver Johansson     def.  Casey Ross          62 61
     SF  Albert Sprlak-Puk    def.  Jeremy Schifris     16 76(5) [8]
     QF  Casey Ross           def.  Neel Raut           61 60
     QF  Oliver Johansson     def.  Gerhard Sullwald    62 64
     QF  Albert Sprlak-Puk    def.  Matt Hulme          62 46 [8]
     QF  Jeremy Schifris      def.  Andrea Zamurri      42 Ret.
  > West
      F  Matt Hulme           def.  Gerhard Sullwald    61 76(3)
     SF  Gerhard Sullwald     def.  Neel Raut           64 64
     SF  Matt Hulme           def.  Andrea Zamurri      Walkover
  > 3-4 Playoff
      F  Jeremy Schifris      def.  Casey Ross          60 62
  > South
      F  Neel Raut            def.  Andrea Zamurri      Walkover
 > Flight B
  > East
      F  Patrick Cacciatore   def.  Stratton Brown      61 36 [7]
     SF  Patrick Cacciatore   def.  Evan Fragistas      36 62 [3]
     SF  Stratton Brown       def.  Nick Aney           61 63
     QF  Evan Fragistas       def.  Simon Birgerson     61 63
     QF  Patrick Cacciatore   def.  Tin Krstulovic      60 61
     QF  Nick Aney            def.  Victor Sklenka      64 46 [8]
     QF  Stratton Brown       def.  Edmond Aynedjian    64 76(5)
  > West
      F  Victor Sklenka       def.  Simon Birgerson     Walkover
     SF  Simon Birgerson      def.  Tin Krstulovic      62 63
     SF  Victor Sklenka       def.  Edmond Aynedjian    64 26 [7]
  > 3-4 Playoff
      F  Evan Fragistas       def.  Nick Aney           64 63
  > South
      F  Edmond Aynedjian     def.  Tin Krstulovic      60 64
 > Flight C
  > East
      F  Markus Bolin         def.  Fabien Calloud      Walkover
     SF  Fabien Calloud       def.  Daniel Fouchier     61 60
     SF  Markus Bolin         def.  Davis Lawley        75 61
     QF  Daniel Fouchier      def.  Nikita Snezhko      76(5) 63
     QF  Fabien Calloud       def.  Rami Scheetz        63 61
     QF  Davis Lawley         def.  Jose Diaz           64 26 [4]
     QF  Markus Bolin         def.  Alex Budde          61 62
  > West
      F  Rami Scheetz         def.  Jose Diaz           63 46 [8]
     SF  Rami Scheetz         def.  Nikita Snezhko      46 63 [9]
     SF  Jose Diaz            def.  Alex Budde          46 64 [8]
  > 3-4 Playoff
      F  Davis Lawley         def.  Daniel Fouchier     Walkover
  > South
      F  Nikita Snezhko       def.  Alex Budde          76(3) 64
 > Flight D
  > East
      F  Matija Matic         def.  Hugo Piles          60 63
     SF  Matija Matic         def.  Caleb Fridinger     60 63
     SF  Hugo Piles           def.  Matthew Lanahan     63 62
     QF  Caleb Fridinger      def.  Andre Saleh         10 Ret.
     QF  Matija Matic         def.  Ian Brady           62 61
     QF  Matthew Lanahan      def.  Jack Bergmeyer      61 62
     QF  Hugo Piles           def.  Franco Oliva        36 76 [6]
  > West
      F  Ian Brady            def.  Franco Oliva        Walkover
     SF  Ian Brady            def.  Andre Saleh         Walkover
     SF  Franco Oliva         def.  Jack Bergmeyer      62 62
  > 3-4 Playoff
      F  Matthew Lanahan      def.  Caleb Fridinger     64 62
  > South
      F  Jack Bergmeyer       def.  Andre Saleh         Walkover
 > Flight E
  > East
      F  Olle Sonesson Lidho… def.  Alvaro Quintana     63 60
     SF  Alvaro Quintana      def.  Cian McDonnell      64 26 [6]
     SF  Olle Sonesson Lidho… def.  Marco Siviero       46 60 [4]
     QF  Cian McDonnell       def.  Jan Jauch           57 64 [7]
     QF  Alvaro Quintana      def.  Oscar Wikstrom      64 62
     QF  Marco Siviero        def.  Pablo Dale          75 63
     QF  Olle Sonesson Lidho… def.  Vinicius Rodrigues  46 61 [8]
  > West
      F  Pablo Dale           def.  Oscar Wikstrom      63 75
     SF  Oscar Wikstrom       def.  Jan Jauch           64 64
     SF  Pablo Dale           def.  Vinicius Rodrigues  36 63 [6]
  > 3-4 Playoff
      F  Cian McDonnell       def.  Marco Siviero       62 57 [6]
  > South
      F  Jan Jauch            def.  Vinicius Rodrigues  Walkover
 > Flight F
  > East
      F  Shin Inoue           def.  Gabriel Sardo       64 67(5) [4]
     SF  Shin Inoue           def.  Shaddy Khalafallah  61 46 [2]
     SF  Gabriel Sardo        def.  Riley Odell         67(3) 61 [6]
     QF  Shin Inoue           def.  Paul-Antoine Brazet 64 63
     QF  Shaddy Khalafallah   def.  Diego Guzman        46 75 [7]
     QF  Riley Odell          def.  Cameron Luhring     64 67(2) [11]
     QF  Gabriel Sardo        def.  Sourabh Terakanambi 63 76(6)
  > West
      F  Cameron Luhring      def.  Paul-Antoine Brazet Walkover
     SF  Paul-Antoine Brazet  def.  Diego Guzman        57 61 [5]
     SF  Cameron Luhring      def.  Sourabh Terakanambi 63 61
  > 3-4 Playoff
      F  Riley Odell          def.  Shaddy Khalafallah  76(3) 64
 > Flight G
  > East
      F  Josh Christensen     def.  Ethan Neil          63 76(9)
     SF  Josh Christensen     def.  Will Tennison       46 63 [9]
     SF  Ethan Neil           def.  Yaswanth Mylavarapu 62 26 [8]
     QF  Will Tennison        def.  Petro Alex          57 61 [4]
     QF  Josh Christensen     def.  Sawyer Nickel       64 61
     QF  Ethan Neil           def.  Nathan Balthazor    63 62
     QF  Yaswanth Mylavarapu  def.  Joe Punnoose        63 64
  > West
      F  Petro Alex           def.  Nathan Balthazor    64 64
     SF  Petro Alex           def.  Sawyer Nickel       61 63
     SF  Nathan Balthazor     def.  Joe Punnoose        63 57 [6]
  > 3-4 Playoff
      F  Will Tennison        def.  Yaswanth Mylavarapu Walkover
  > South
      F  Joe Punnoose         def.  Sawyer Nickel       Walkover
 > Flight H
  > Main
     R3  Zack Maline          def.  Brent Fallon        36 63 [10]
     R3  Ethan Henry          def.  Elijah Zifferblatt  76(4) 60
     R2  Brent Fallon         def.  Taona Mhwandagara   64 36 [7]
     R2  Elijah Zifferblatt   def.  Sean Bochman        62 61
     R1  Zack Maline          def.  Taona Mhwandagara   76(4) 46 [7]
     R1  Sean Bochman         def.  Ethan Henry         63 62
  > Playoff 1
      F  Zack Maline          def.  Elijah Zifferblatt  64 64
  > Playoff 2
      F  Ethan Henry          def.  Brent Fallon        Walkover
 > Sunday Bonus Matches
  > Main
     16  Markus Bolin         def.  Victor Sklenka      61 20 Ret.
     16  Ian Brady            def.  Neel Raut           36 64 [3]
     16  Cameron Luhring      def.  Jan Jauch           63 26 [6]
     16  Ethan Henry          def.  Joe Punnoose        64 76(6)
     16  Davis Lawley         def.  Taona Mhwandagara   61 61
~~~
...
════════════════════════════════════════════════════════════════════════
  ...
  Dates: Sep 17-19, 2021
  Host: Purdue University (M)
════════════════════════════════════════════════════════════════════════
 Men's Open Singles
 > Purdue/IUPUI, Ball St./DePaul
  > Main
     64  Gabriele Brancatelli def.  Alex Jochim          64 75
     64  Athell Bennett       def.  Sean Bailey          63 64
     64  Rohan Sachdev        def.  Blessing Benibo      64 62
     64  Julen Morgan         def.  Kamil Kozerski       76(2) 63
     64  Tomasz Dudek         def.  Noah Viste           62 62
     64  Michal Wozniak       def.  Nicholas Moody       64 63
     64  Thibaut de Negri     def.  Luuk Wassenaar       63 75
     64  Tripp Tuff           def.  Danilo Kovacevic     16 64 75
     64  Chris Adams          def.  Lars Minsaas         36 61 64
     64  Nathaniel Webster    def.  Leon Huck            63 64
     64  Antonio Matteo Iaqu… def.  Eli Herran           26 76(3) 64
     64  Parrish Simmons      def.  Jona Gitschel        60 62
     64  Vince Orlando        def.  Sven Moser           61 60
     64  Abe Wojtalik         def.  Phasu Sirinit        61 36 62
 > Purdue/DePaul, IUPUI/Ball St.
  > Main
     64  Rohan Sachdev        def.  Tripp Tuff           62 63
     64  Lars Minsaas         def.  Gabriele Brancatelli 60 61
     64  Tomasz Dudek         def.  Leon Huck            76(5) 63
     64  Julen Morgan         def.  Jona Gitschel        76(4) 36 62
     64  Sven Moser           def.  Noah Viste           64 76(2)
     64  Phasu Sirinit        def.  Canaan Sellers       64 62
     64  Danilo Kovacevic     def.  Sean Bailey          36 63 62
     64  Thibaut de Negri     def.  Alex Jochim          76(5) 57 75
     64  Kamil Kozerski       def.  Nathaniel Webster    46 76(4) Ret.
     64  Parrish Simmons      def.  Blessing Benibo      76(5) 75
     64  Vince Orlando        def.  Colton Morehart      61 76(5)
     64  Eli Herran           def.  Nathan Day           60 64
     64  Abe Wojtalik         def.  Nicholas Moody       60 61
 > Petrovic/Sellers
  > Main
      F  Canaan Sellers       def.  Petar Petrovic       46 63 63
 > Purdue/Ball St., IUPUI/DePaul
  > Main
     64  Rohan Sachdev        def.  Nathaniel Webster    63 57 76(1)
     64  Eli Herran           def.  Tomasz Dudek         57 63 75
     64  Gabriele Brancatelli def.  Vince Orlando        61 63
     64  Milledge Cossu       def.  Abe Wojtalik         64 64
     64  Julen Morgan         def.  Petar Petrovic       61 16 62
     64  Tripp Tuff           def.  Emil Jankowski       61 62
     64  Lars Minsaas         def.  Alex Jochim          76(5) 64
     64  Leon Huck            def.  Blessing Benibo      75 62
     64  Antonio Matteo Iaqu… def.  Kamil Kozerski       76(5) 62
     64  Colton Morehart      def.  Jona Gitschel        64 62
     64  Sven Moser           def.  Nathan Day           64 62
     64  Noah Viste           def.  Phasu Sirinit        62 16 62
~~~
...
═══════════════════════════════════════════════════════════════════════
 ...
 > Draw
  > Main
      F  Agustin Tamagnone    def.  Alex Gurmendi        36 Ret.
     SF  Alex Gurmendi        def.  Gabriel Ortiz        36 64 [7]
     SF  Agustin Tamagnone    def.  Daniel Czepielewski  63 62
     QF  Alex Gurmendi        def.  German DelCanto      64 62
     QF  Gabriel Ortiz        def.  Jose Dugo            64 63
     QF  Agustin Tamagnone    def.  Jodi Puig            60 63
     QF  Daniel Czepielewski  def.  Valentino Caratini   Walkover
     16  Alex Gurmendi        def.  Pau Pujadas          64 46 [5]
     16  German DelCanto      def.  Sam Alexander        64 63
     ...
     32  Pau Pujadas          def.  Luis Rosselot        57 63 Ret.
     32  German DelCanto      def.  Rikhardt Bierman     64 61
     32  Sam Alexander        def.  Jovial Barry         60 60
     32  Gabriel Ortiz        def.  Matthew Sloan        61 63
     32  Jesus Fernandez      def.  Augustya Sharma      61 62
     32  Jose Dugo            def.  Zoilo Rios           63 36 [9]
     32  Ernesto Martinez     def.  Patricio Gallegos    61 36 [6]
     ...
     32  Valentino Caratini   def.  Guido Picasso        62 62
     64  Luis Rosselot        def.  Santiago Speranza    76(1) 64
     64  Pau Pujadas          def.  Max Stewart          62 62
     ...
     64  Guido Picasso        def.  Gavin Thomas         62 46 [6]
  > Consolation
     SF  Matthew Sloan        def.  Max Stewart          64 16 [7]
     QF  Max Stewart          def.  Guido Luna           Default
     QF  Matthew Sloan        def.  Zoilo Rios           60 60
     QF  Max Duzinkiewicz     def.  Rubin Howard         26 Ret.
     16  Matthew Sloan        def.  Augustya Sharma      60 60
     32  Guido Luna           def.  Alan Toleu           61 60
~~~
